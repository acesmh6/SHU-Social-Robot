...
int previous = 99, love = 0;	//added global variables previous and love (avoid passing between functions)
...
*/
  ...
  else if (feedback->content.compare("convo_1") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_1.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_2") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_2.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_3") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_3.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_4") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_4.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_5") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_5.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_6") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_6.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_7") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_7.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_8") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_8.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }

  else if (feedback->content.compare("convo_9") == 0)
        {
                previous = 99;	// 99 = no sense state
                system("aplay /home/social-robot/Emma/Convo_9.wav");
                SF.content = feedback->content;
                SF.speechIsCompleted = true;
                speech_feedback_pub.publish(SF);
        }
