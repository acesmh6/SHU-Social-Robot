...
// Start THE code
if (cmd->data.compare("all i know is that i know nothing") == 0 || cmd->data.compare("you know nothing jon snow") == 0)
	{
		speech_cmd.content = "johnsnow";	//set to howfeeling
		speech_cmd.feeling = "happy";
		speech_request_pub.publish(speech_cmd);
	}

if (cmd->data.compare("howareyou") == 0 || cmd->data.compare("howareyoufeeling") == 0 || cmd->data.compare("howdoyoufeel") == 0)
	{
...
if (cmd->data.compare("doyoulikeithere") == 0 || cmd->data.compare("doyoulikehere") == 0 || cmd->data.compare("doyoulikethisplace") == 0)
	{
...
if (cmd->data.compare("whatdoyouthinkofme") == 0 || cmd->data.compare("doyoulikeme") == 0)
	{
...
if (cmd->data.compare("doyoulikeyourself") == 0)
	{
...
if (cmd->data.compare("whatisthemeaningoflife") == 0)
	{
...
if (cmd->data.compare("whatistheqestionoflife") == 0 || cmd->data.compare("what is the question to the meaning of life") == 0)
	{
...
if (cmd->data.compare("doyoufollowthethreelaws") == 0)
	{
...
if (cmd->data.compare("doyouknowanyotherrobots") == 0 || cmd->data.compare("doyouknowanyrobots") == 0 || cmd->data.compare("doyouhaveanyfriends") == 0 || cmd->data.compare("doyouhavefriends") == 0)
	{
...
if (cmd->data.compare("whatdoyouthinkofpepper") == 0 || cmd->data.compare("doyoulikepepper") == 0)
	{
...
if (cmd->data.compare("doyouhaveanyfamily") == 0 || cmd->data.compare("doyouhavefamily") == 0)
	{
...
if (cmd->data.compare("who created you") == 0 || cmd->data.compare("whoisyourcreator") == 0 || cmd->data.compare("whoareyourcreators") == 0 || cmd->data.compare("whomadeyou") == 0)
	{
...
if (cmd->data.compare("howoldareyou") == 0 || cmd->data.compare("whatageareyou") == 0)
	{
...
if (cmd->data.compare("canyouusetheinternet") == 0 || cmd->data.compare("canyouaccesstheinternet") == 0)
	{
...
if (cmd->data.compare("whatissyouripaddress") == 0 || cmd->data.compare("doyouhaveanipaddress") == 0)
	{
...
// End of THE code
	if (cmd->data.compare("thank you") == 0)
	{
  ...
  if (cmd->data.compare("hi") == 0 || cmd->data.compare("hello") == 0)
	{
	...
	{
		speech_cmd.content = "mynameisbetty";
		speech_cmd.feeling = "happy";
		speech_request_pub.publish(speech_cmd);
	}
